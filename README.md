...
When ambling about, they do that for some time, but then they lose interest in that and start to do something else instead.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTczODgyNTIzNCw0NDM4NDkzNjQsMTQ4Nz
