...
But what are other, more efficient and not as demanding ways of doing blood splatter? I could imagine just actually creating textures as we go, using pixmaps, 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwNjcxNTUwMjMsLTM2ODg1MzUxMiwyMT
