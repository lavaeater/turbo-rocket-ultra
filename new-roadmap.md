...
|---|---------|---------|--------|
| 1 | PauseScreen + GameOverScreen | Biggest gap for basic game feel | 1 day |
| 2 | GameScreen transition (fix VFX/NestableFrameBuffer) | Polish, already partially solved | Half day |
| 3 | Enemy stuck recovery (re-path on stuck) | Gameplay quality, embarrassing AI bug | Half day |
| 4 | Boss behavior tree using existing tasks | New enemy type, zero new infrastructure | 1 day |
| 5 | Wave spawning | Game feel, already designed | Half day |
| 6 | Wire SplitScreenViewport (static split) | Big payoff, code already written | 1 day |
| 7 | Ranged enemy (FireProjectile task) | Makes the game harder and more interesting | 1 day |
| 8 | Towers — build mode + resource system | Fun feature, partial code exists | 3 days |
| 9 | Hardpoint integration into GameScreen | Leads to much better character rendering | 2 days |
| 10 | Vehicles | The original vision — do it when the rest feels solid | 2-3 weeks |
