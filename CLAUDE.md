...
`core/.../injection/Context.kt` provides singleton factories. Systems and screens use `inject<Type>()` (KTX inject) to get cameras, viewports, the Ashley engine, Box2D world, audio, UI, etc. Lazily initialized.
